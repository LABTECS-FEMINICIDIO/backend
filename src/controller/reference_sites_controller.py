...
from src.views.reference_sites_views import (
    createReferenceSite,
    deleteReferenceSites,
    listAllREferenceSites,
    updatePesquisarField,
    updateReferenceSite,
)
...
@router.delete("/referenceSite/{site_id}")
async def delete_reference_site_controller(site_id):
    return await deleteReferenceSites(site_id)
