            ...
            for result in search_results:
                if result and result.get('data-ved', ''):
                    ...
                    if href and href.startswith('/url?q='):
                        ...
                        if "tiktok" not in site_name and "twitter" not in site_name and "youtube" not in site_name and "instagram" not in site_name and "tag" not in url and "facebook" not in site_name:
